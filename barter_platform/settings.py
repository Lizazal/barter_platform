...
SECRET_KEY = "django-insecure-!y23$)h5(-)kx=_)g(v9rr@fnjl8y@=wiesgnu-8gsc424=udz"
# В продакшене ключ стоит добавить в .env, но для простоты проверки я его оставляю
